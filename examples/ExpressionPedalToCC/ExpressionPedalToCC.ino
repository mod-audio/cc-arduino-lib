...
void setup() {
    ...
    const char *uri = "https://github.com/moddevices/cc-arduino-lib/tree/master/examples/ExpressionPedalToCC";
    ...
    for (int i=0; i<amountOfPorts; i++)
    {
      ...
      switch (i)
      {
        case 0: actuator_config.name = "Chan #1"; break;
        case 1: actuator_config.name = "Chan #2"; break;
        case 2: actuator_config.name = "Chan #3"; break;
        case 3: actuator_config.name = "Chan #4"; break;
        case 4: actuator_config.name = "Chan #5"; break;
        case 5: actuator_config.name = "Chan #6"; break;
        case 6: actuator_config.name = "Chan #7"; break;
        case 7: actuator_config.name = "Chan #8"; break;
      }
